...
$pf_link_text = get_post_meta( get_the_ID(), '_celebrate_pf_link_text', true ); ?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php if ( ! post_password_required() ) : ?>
	<div class="tc-pf-link">
		...
		<?php endif; ?>
		<div class="tc-pf-link-content">
			<?php get_template_part( '/includes/templates/entry', 'title' ); ?>
			<span class="tc-pf-link-text"> <?php echo esc_attr( $pf_link_text ) ?> </span> </div>
	</div>
	<?php endif; ?>
