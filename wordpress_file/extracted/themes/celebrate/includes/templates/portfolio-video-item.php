...
$celebrate_portfolio_imglink      = celebrate_option( 'celebrate_portfolio_imglink', true, true ) ? true : false;
...
$celebrate_video_url 		      = get_post_meta( $post->ID, '_celebrate_video_url', true );  
// image size
...
<div class="tc-up-hover<?php echo esc_attr( $return_scale ) ?><?php echo esc_attr( $return_icon_position ) ?>">
	<div class="tc-hover-wrapper">
		...
		<div class="tc-hover-image">
			...
			<a class="tc-media-zoom" href="<?php echo esc_url( $celebrate_video_url ); ?>" data-rel="prettyPhoto"></a>
			<?php } ?>
