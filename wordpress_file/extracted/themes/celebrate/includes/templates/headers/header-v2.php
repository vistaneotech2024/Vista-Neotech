...
$celebrate_show_pri_header_text 	= celebrate_option( 'celebrate_show_pri_header_text', true, true ) ? true : false;
...
<div class="<?php echo esc_attr( $celebrate_return_header_transparent); ?> clearfix">
	...
	<div id="tc-header-primary" class="clearfix">
		<div class="main-container">
			<?php if( $celebrate_show_pri_header_text ) { ?>
			<div class="tc-header-pri-text"><?php echo wp_kses_post( celebrate_option( 'celebrate_pri_header_custom_text' ) ); ?> </div>
			<?php } ?>
