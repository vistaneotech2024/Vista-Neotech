...
$pf_audio_embed = get_post_meta( get_the_ID(), '_celebrate_pf_audio_embed', true ); ?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php if ( ! post_password_required() ) : ?>
	<div class="tc-audio-wrapper">
		<?php  echo wp_kses( $pf_audio_embed, celebrate_embed_allowed_tags() ); ?>
	</div>
	<?php endif; ?>
	<?php if ( ! is_page()  ) : ?>
